...
int[,,] Generate3DArray(int numberOfRows, int numberOfColumns, int numberOfDepth, int[] numbersOfArray)
{
...
void PrintArray(int[] incomingArray)
{
    ...
    for (int i = 0; i < incomingArray.GetLength(0); i++)
    {
        ...
        {
            count++;
            Console.WriteLine($"[{i}] {incomingArray[i]}");
        }
    }
...
int[,,] array3D = Generate3DArray(3, 3, 3, numbersOfArray);
Print3DArray(array3D);
Console.WriteLine();
PrintArray(numbersOfArray);
